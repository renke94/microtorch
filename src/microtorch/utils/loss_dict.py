...
class LossDict(pd.Series):
    """Loss dictionary class extending the pandas Series. This is a helper class to accumulate and average loss values during training without the need to store the values in lists.
